...
const Sidebar = () => {
    ...
    return (
        <div className={`fixed h-[calc(100vh_-_72px)]
            drop-shadow-md
            flex-col items-center 
            lg:w-16
            md:w-16
            text-gray-700 bg-white 
            ${mounted && ("lg:w-[300px] md:w-[300px] w-[300px]")} 
            duration-300
            overflow-hidden
            z-50
            `}>
            {!mounted ? 
               ...
               ${mounted && ("lg:w-[300px] md:w-[300px]")}  active:animate-fadeRight`} 
                    onClick={openSideBar}>
            ...
            <div className={`flex items-center mx-auto mt-2 border-t border-gray-300`}>
                    ...
                    sideBarItem.map((item, key) => {
                        return (
                            <NavLink
                                ...
                                `}
                            >   
                                <div className={`w-16 duration-300 ${mounted && "w-full md:w-[300px] lg:w-[300px]"}`}>
                                    <div 
                                            className={` 
                                            items-center
                                            h-12 mt-2
                                            hover:bg-gradient-to-r from-cyan-200 to-blue-600
                                            flex
