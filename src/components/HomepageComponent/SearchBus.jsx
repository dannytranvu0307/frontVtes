    ...
    <div className='pt-3'>
        <div className='flex pb-[40%]'>
            ...
            <span className='my-2 text-xs'>{t("arrival")}</span>
               <div className=' '><input   className={`w-full border-[1px] border-black rounded h-8 px-5 ${error.arrival&&("border-red-500 bg-red-100")}`} value={data.departure} onChange={e =>{onArrival(e.target.value),setError({...error,arrival:false})}}/></div> 
            </div>
